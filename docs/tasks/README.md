...
Closes the product loop: *compose → bake → distribute → perform*. B01→B02→B03 strictly
in order. After B02 lands, the hand-baked `docs/demo` bundle can be regenerated by the
real pipeline; after B03, no manual file transfer is needed at all.
