...
Wired in A01: `com.troubastack.app` with a `MainActivity` that shows a Compose placeholder
(the TroubaStage name + an inert "Stage" button). `./gradlew :androidApp:assembleDebug` produces
