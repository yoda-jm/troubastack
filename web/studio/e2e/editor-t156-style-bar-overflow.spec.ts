...
// ⟨B⟩ The size legend moved OUT of the toolbar and onto the page (VLL: the ctx-bar chip was capped to the
// bar height). The stroke ring + text sample previews now live on the canvas and are covered by
// editor-ctx-thin.spec.ts ("true-scale ring …" and "text sample …"). The old toolbar-preview tests were
