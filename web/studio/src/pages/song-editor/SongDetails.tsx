...
// The open text-chart editor state: a new chart (no fileId) or an existing generated file's source
// (fileId + the revision we based the edit on). Type + component now shared with the route host (T105).
